...
<form align="center" action="<?php echo $action; ?>" method="post">
  ...
  <p>Nombre de Kilomètre(s) parcourus :<br/><input  name="km_parcourus" required="required" type="text" value="<?php echo $lignefrais->getkm_parcourus(); ?>" /></p>
  <p>Coût du/des Péage(s)<br/><input  name="cout_peage" required="required"  type="text" value="<?php echo $lignefrais->getCout_peage();?>" /></p>
  <p>Coût du/des Repas<br/><input  name="cout_repas" required="required"  type="text" value="<?php echo $lignefrais->getCout_repas();?>" /></p>
  <p>Coût du/des Hébergement<br/><input  name="cout_hebergement" required="required" type="text" value="<?php echo $lignefrais->getCout_hebergement();?>"/></p>
