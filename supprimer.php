...
if ($submit) {
    ...
    echo '<h2>Ligne supprimer</h2>';

    // Ajoute l'enregistrement dans la BDD
    $nb = $lignefraisDAO->deleteligne_frais($id_ligne_frais);
...
// Ajout du formulaire d'inscription
    ...
    include 'forms/ADH_supprimer_Form.php';
?>

        </div>
</div>

<p align="center"><a href="<?php echo $_SERVER['HTTP_REFERER']; ?>">Retour</a> | <a href="index.php">Page d'accueil</a></p></p>
